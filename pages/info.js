    ...
    <div className="infopage">
      ...
      <div className="tarifas">
        ...
        <div className={show2 ? "box" : "nobox"}>
          ...
          <h3>
            La duración de las clases es de 1h, pudiendo llegar 15 minutos antes
            para el calentamiento previo y 15 minutos a la finalización de la
            misma para realizar los correspondientes estiramientos. En caso de
            que el atleta quiera ampliar la duración de las mismas deberá
            solicitar un cambio de tarifa o contratar bonos adicionales de
            horas.
          </h3>
          <h3>
          ...
          <h3>
            La puntualidad es imprescindible para la asistencia a las clases, en
            caso de retraso sin causa justificada, el atleta deberá esperar el
            comienzo de la siguiente clase siempre que sea posible y haya aforo
            en la misma.
          </h3>
          <h3>
